<?php
	...
	if (isset($_POST['btnMenuID'])) {
		...
		$menuItemQuery = "SELECT itemID,menuItemName FROM tbl_courseitem WHERE menuID = " . $menuID;
	...
	if (isset($_POST['btnMenuItemID']) && isset($_POST['qty'])) {
		...
		$menuItemQuery = "SELECT mi.itemID,mi.menuItemName,mi.price,m.menuName FROM tbl_courseitem mi LEFT JOIN tbl_courselist m ON mi.menuID = m.menuID WHERE itemID = " . $menuItemID;
